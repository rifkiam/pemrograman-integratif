...
client.on('message', (topic, message) => {
    ...
    mssql.query(`INSERT INTO log_masuk (id_kartu_akses, id_register_gate, date_time, is_valid) VALUES (${part1}, ${part2}, GETDATE(), 1);`, (err) => {
      // console.log(err)
      if (err) {
        console.log(0)
        client.publish('masuk_result', "0")
      }
      else
      {
        console.log(1)
        client.publish('masuk_result', "1")
      }
    })
